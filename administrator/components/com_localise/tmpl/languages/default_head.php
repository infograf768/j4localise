...
<?php else : ?>
	<tr>
		...
		<th class="center"><?php echo \JHtml::_('searchtools.sort', 'COM_LOCALISE_HEADING_LANGUAGES_NAME', 'name', $listDirn, $listOrder); ?></th>
		<th class="center"><?php echo \JHtml::_('searchtools.sort', 'COM_LOCALISE_HEADING_LANGUAGES_TAG', 'tag', $listDirn, $listOrder); ?></th>
		<th class="center"><?php echo \JHtml::_('searchtools.sort', 'COM_LOCALISE_HEADING_LANGUAGES_CLIENT', 'client', $listDirn, $listOrder); ?></th>
